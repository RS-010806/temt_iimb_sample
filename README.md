...
- Four sector scenarios and a dated official NIFTY 500 constituent directory.
...
| Workspace | Purpose |
| --- | --- |
| `apps/web` | Next.js App Router static export, React, Tailwind CSS, Motion, Recharts and Lucide |
