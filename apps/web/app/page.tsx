  ...
  return <>
    ...
    <main id="main">
      <section className="hero" aria-labelledby="hero-title">
        <picture><source media="(max-width: 700px)" srcSet="/images/freight-port-mobile.avif"/><img className="hero-image" src="/images/freight-port-desktop.avif" width="1600" height="1067" alt="Container stacks and gantry cranes at a freight terminal" fetchPriority="high" /></picture>
        ...
        <div className="hero-inner page-width">
          <div className="hero-copy">
            ...
            <div className="hero-actions"><Link className="button button-orange" href="/demo/">Run your scenario <ArrowUpRight size={18} /></Link><a className="text-link light-link" href="#platform">Explore the platform <ArrowRight size={17} /></a></div>
